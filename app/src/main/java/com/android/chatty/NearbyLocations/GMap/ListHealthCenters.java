 ...
 *
 */
package com.android.chatty.NearbyLocations.GMap;
...
import com.android.chatty.Adapter.CustomPlacesAdapter;
import com.android.chatty.MainActivityHospital;
import com.android.chatty.NearbyLocations.GeometryController;
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Toast.makeText(ListHealthCenters.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    MainActivityHospital.progressDialog.cancel();
                    e.printStackTrace();
                    finish();
                }
            }
