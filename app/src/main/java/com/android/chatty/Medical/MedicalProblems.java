package com.android.chatty.Medical;
...
import com.android.chatty.MainActivityHospital;
import com.android.chatty.R;

import java.util.ArrayList;
import com.android.chatty.Adapter.CustomMedicalProblemsAdapter;
import com.android.chatty.MainActivityHospital;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.runOnUiThread(new Runnable() {
            ...
            public void run() {
                fillProblemsImages();
                fillProblemsText();
                com.android.chatty.Adapter.CustomMedicalProblemsAdapter customMedicalProblemsAdapter = new CustomMedicalProblemsAdapter(MedicalProblems.this, problemsImages, problemsText);
        ...
        if(MainActivityHospital.progressDialog!=null) MainActivityHospital.progressDialog.cancel();
    }
