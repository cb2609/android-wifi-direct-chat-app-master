...
import com.android.chatty.Medical.MedicalProblems;
import com.android.chatty.NearbyLocations.GMap.ListHealthCenters;

public class MainActivityHospital extends AppCompatActivity {
    ...
    void medicalProblems() {
        loading("Loading...");
        Intent intent = new Intent(MainActivityHospital.this, MedicalProblems.class);
    ...
    void hospitalLocations() {
        if(isNetworkAvailable()) {
            ...
            Intent intent = new Intent(MainActivityHospital.this, ListHealthCenters.class);
            startActivity(intent);
        }else
